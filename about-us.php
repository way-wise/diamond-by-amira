...
<section class="py-12 md:py-16">
    <div class="container-wrapper">
        ...
        <div class="mb-16 md:mb-24">
            <h2 class="text-2xl md:text-3xl lg:text-4xl font-bold text-black text-center mb-4">
                From Diamonds to Stages – Your Perfect Seat Awaits
            </h2>
            <p class="text-[#666666] text-center max-w-3xl mx-auto mb-12 leading-relaxed">
                For a truly dynamic way to buy tickets to your favorite events, Amira Diamonds is your go-to. Designed for the modern ticket buyer, Amira Diamonds offers a seamless experience that puts you in control. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>
            ...
            <p class="text-[#666666] text-center max-w-4xl mx-auto mt-8 leading-relaxed">
        ...
        <div class="grid md:grid-cols-2 gap-8 md:gap-12 items-center mb-16 md:mb-24">
            <div class="order-2 md:order-1">
                <img src="/assets/images/about-us-diamond.png" alt="Diamond" class="w-full h-auto rounded-lg">
            </div>
        ...
        <div class="grid md:grid-cols-2 gap-8 md:gap-12 items-center mb-16 md:mb-24">
            ...
            <div>
                <img src="/assets/images/about-us-ring.png" alt="Ring Detail" class="w-full h-auto rounded-lg">
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-8 md:gap-12 items-center mb-16 md:mb-24">
            <div class="order-2 md:order-1">
                <img src="/assets/images/about-us-ring-hand.png" alt="Ring on Hand" class="w-full h-auto rounded-lg">
            </div>
            <div class="order-1 md:order-2">
                <h3 class="text-2xl md:text-3xl font-bold text-black mb-4">
                    Contrary to popular belief, Lorem Ipsum is not simply.
