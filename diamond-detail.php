<?php
$pageTitle = "0.50ct Round Natural Diamond";
$currentPage = "product";
        ...
        <div class="flex items-center justify-between max-w-3xl mx-auto">
            ...
            <div class="flex items-center gap-3 flex-1">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-full bg-[#00B67A] text-white flex items-center justify-center font-bold text-sm">
                    ...
                    <div class="hidden sm:block">
                        <div class="text-xs text-[#666666]">The Bezel Set Solitaire</div>
                        <div class="text-sm font-bold text-black">$542.00 CAD</div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3 flex-1">
                <div class="flex items-center gap-3">
                    ...
                    <div class="hidden sm:block">
                        ...
                        <div class="text-sm font-bold text-black">DIAMOND</div>
                    </div>
                </div>
            </div>
...
<section class="py-8 md:py-12">
    <div class="container-wrapper">
        <div class="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div>
                <!-- Main Slider -->
                <div class="swiper diamondMainSwiper mb-4 bg-[#F7F5F5] rounded-lg overflow-hidden">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="aspect-square flex items-center justify-center p-8">
                                <img src="/assets/images/products/product-01.png" alt="Diamond" class="w-full h-full object-contain">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="aspect-square flex items-center justify-center p-8">
                                <img src="/assets/images/products/product-02.png" alt="Diamond" class="w-full h-full object-contain">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="aspect-square flex items-center justify-center p-8">
                                <img src="/assets/images/products/product-03.png" alt="Diamond" class="w-full h-full object-contain">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="aspect-square flex items-center justify-center p-8">
                                <img src="/assets/images/products/product-04.png" alt="Diamond" class="w-full h-full object-contain">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="aspect-square flex items-center justify-center p-8">
                                <img src="/assets/images/products/product-05.png" alt="Diamond" class="w-full h-full object-contain">
                            </div>
                        </div>
                    </div>
                    <!-- Navigation Buttons -->
                ...
                <!-- Thumbnail Slider -->
                <div class="swiper diamondThumbSwiper">
                    <div class="swiper-wrapper">
            ...
            <!-- Product Info -->
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-black mb-4">0.50ct Round Natural Diamond</h1>
                
                <!-- Product Meta -->
                <div class="flex items-center gap-4 text-sm text-[#666666] mb-6">
                    <span>Color | F</span>
                    <span>Clarity: SI1</span>
                    <span>Cut: Ideal</span>
                </div>

                <!-- Price -->
                <div class="mb-6">
                    <div class="text-xs text-[#666666] mb-2">Price Only for Diamond</div>
                    <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-2 mb-6">
                    <div class="flex items-center gap-2 bg-[#F7F5F5] px-3 py-2 rounded-lg">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10 1L12.5 6.5L18.5 7.5L14.25 11.5L15.5 17.5L10 14.5L4.5 17.5L5.75 11.5L1.5 7.5L7.5 6.5L10 1Z" fill="#FFD700" stroke="#FFD700" stroke-width="1.5"/>
                        </svg>
                        <span class="text-sm font-medium text-black">IGI Certified</span>
                    </div>
                    <span class="text-xs text-white bg-[#00B67A] px-2 py-1 rounded">In-Stock</span>
                </div>
                ...
                <div class="border-t border-[#E5E5E5]">
                    <details class="group border-b border-[#E5E5E5]" open>
                        ...
                        <div class="pb-4 text-sm text-[#666666] space-y-2">
                            ...
                            <p><strong>Carat:</strong> 0.50</p>
                            <p><strong>Color:</strong> F</p>
                            <p><strong>Clarity:</strong> SI1</p>
                            <p><strong>Cut:</strong> Ideal</p>
                ...
                <div class="mt-6 pt-6 border-t border-[#E5E5E5]">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="#" class="text-[#666666] hover:text-black transition-colors">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.3333 1.66667H6.66667C3.90524 1.66667 1.66667 3.90524 1.66667 6.66667V13.3333C1.66667 16.0948 3.90524 18.3333 6.66667 18.3333H13.3333C16.0948 18.3333 18.3333 16.0948 18.3333 13.3333V6.66667C18.3333 3.90524 16.0948 1.66667 13.3333 1.66667Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M13.3333 9.475C13.4362 10.1685 13.3178 10.8769 12.9948 11.4992C12.6718 12.1215 12.161 12.6262 11.5347 12.9414C10.9084 13.2566 10.1987 13.3663 9.50641 13.255C8.81409 13.1436 8.17484 12.8167 7.67895 12.3208C7.18306 11.8249 6.85618 11.1857 6.74482 10.4934C6.63346 9.80105 6.74315 9.09136 7.05836 8.46506C7.37357 7.83875 7.87827 7.32798 8.50058 7.00497C9.12289 6.68196 9.83131 6.56357 10.5248 6.66667C11.2324 6.77153 11.8874 7.10123 12.393 7.60682C12.8986 8.11241 13.2283 8.76741 13.3333 9.475Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </a>
                            <a href="#" class="text-[#666666] hover:text-black transition-colors">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M13.3333 17.5V4.16667C13.3333 3.72464 13.1577 3.30072 12.8452 2.98816C12.5326 2.67559 12.1087 2.5 11.6667 2.5H8.33333C7.89131 2.5 7.46738 2.67559 7.15482 2.98816C6.84226 3.30072 6.66667 3.72464 6.66667 4.16667V17.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </a>
                            <a href="#" class="text-[#666666] hover:text-black transition-colors">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
document.addEventListener('DOMContentLoaded', function() {
    // Thumbnail Swiper
    const thumbSwiper = new Swiper('.diamondThumbSwiper', {
        spaceBetween: 10,
        slidesPerView: 5,
        freeMode: true,
    ...
    // Main Swiper
    const mainSwiper = new Swiper('.diamondMainSwiper', {
        spaceBetween: 10,
        navigation: {
...
<style>
.diamondThumbSwiper .swiper-slide-thumb-active .aspect-square {
