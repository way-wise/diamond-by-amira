            ...
            <div class="p-[9px] border border-[#D7D7D7] bg-white rounded-md">
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_225_1994)">
                        ...
                        <path d="M20.8949 2.01544C20.5517 1.67226 19.9952 1.67226 19.652 2.01544L17.8942 3.77326C17.5509 4.1165 17.5509 4.67296 17.8942 5.01621C18.2374 5.35945 18.7939 5.35939 19.1371 5.01621L20.8949 3.25839C21.2382 2.91515 21.2382 2.35869 20.8949 2.01544Z" fill="#7B7B7B" />
                    </g>
                    <defs>
