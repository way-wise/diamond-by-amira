<?php
?>
<section class="relative text-white py-8 md:py-12 lg:py-12 overflow-hidden px-4 md:px-8 lg:mx-16">
    <!-- Background decorative elements - Golden light streaks from top right -->
    <div class="absolute inset-0 rounded-2xl md:rounded-3xl overflow-hidden">
    ...
    <div class="container-wrapper relative z-10">
        ...
        <div class="text-center">
            <span class="inline-flex items-center justify-center gap-2 px-3 py-1.5 bg-white text-xs md:text-sm text-black rounded-full mb-4 md:mb-6">
                ...
                <span class="whitespace-nowrap">Design Your Own Diamond Jewellery</span>
            </span>
            <h1 class="text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-4 md:mb-6 leading-tight px-2">
                Buy Diamonds the Smarter Way
            </h1>
            <p class="text-sm md:text-base lg:text-lg xl:text-xl text-gray-300 mb-6 md:mb-8 max-w-2xl mx-auto leading-relaxed px-4">
