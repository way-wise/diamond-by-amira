    ...
    <div class="container-wrapper">
        ...
        <div class="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div>
                ...
                <!-- Price -->
                <div class="mb-6">
                    <div class="text-xs text-[#666666] mb-2">Final Shipping</div>
                ...
                <div class="border-t border-[#E5E5E5]">
                    <details class="group border-b border-[#E5E5E5]" open>
                        ...
                        <div class="pb-4 text-sm text-[#666666]">
                            <p>Detailed product specifications and information.</p>
                        </div>
                    </details>
                    ...
                    <details class="group border-b border-[#E5E5E5]">
                        ...
                        <div class="pb-4 text-sm text-[#666666]">
                            <p>We stand behind our products with a 100% money-back guarantee.</p>
                        </div>
                    </details>
                    ...
                    <details class="group border-b border-[#E5E5E5]">
                        ...
                        <div class="pb-4 text-sm text-[#666666]">
                            <p>Enjoy free returns within 30 days and complimentary resizing.</p>
                        </div>
                    </details>
                </div>
                ...
                <div class="mt-6 space-y-3">
                    ...
                    <div class="flex items-center gap-2 text-sm">
                        ...
                        <span class="text-[#666666]">30-day returns, no fine print</span>
                    </div>
                </div>
